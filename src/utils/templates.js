const templates = {
  ...
  information: () => {
    return {
      message: 'Claro que sí, los guantes están fabricados de *60%* Algodón, *33%* Poliéster y *7%* Elastano de grado médico, son lavables, perfectos para aliviar el dolor causado por las artritis o túnel carpiano, el precio es de *$59,900* pesos colombianos\n\n💬 Si tiene más preguntas no dude en compartirlas con nosotros por favor',
      priority: 'urgent',
      media: {
